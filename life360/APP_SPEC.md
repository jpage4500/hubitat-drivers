...
handleMemberLocationResponse(response, data):
  ...
  switch(status):
    ...
    any 5xx except 501/505: applyTransientBackoff(memberId)        # per-member backoff, §5
...
| any `5xx` except `501`/`505` / network error (no status) | **per-member** exponential backoff (below)                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                |
