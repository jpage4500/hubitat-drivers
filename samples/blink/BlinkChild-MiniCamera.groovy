/*
* BlinkChild-MiniCamera
*
* Description:
* This Hubitat driver provides a spot to put data from Blink MiniCameras (owls)
*
...
* Ability to Arm/Disarm the system the MiniCamera is on
...
* 
* KNOWN ISSUE(S):
* MiniCameras (Owls) have a set of limitations. It is not known if these are device or API limitations:
...
* 0.1.3 - Changes to better support getting thumbnails
* 0.1.2 - Added the ImageCapture capability
...
// Driver Metadata
metadata{
	definition( name: "BlinkChild-MiniCamera", namespace: "Snell", author: "David Snell", importUrl: "https://www.drdsnell.com/projects/hubitat/drivers/BlinkChild-MiniCamera.groovy" ) {
        capability "Sensor"
        capability "Actuator"
        capability "Switch"
        ...
        // Commands
        command "on", [ [ name: "This will Arm system MiniCamera is part of" ] ]  // 
        command "off", [ [ name: "This will Disarm system MiniCamera is part of" ] ]  // 
        command "SystemArm", [ [ name: "This will Arm system MiniCamera is part of" ] ]  // 
        command "SystemDisarm", [ [ name: "This will Disarm system MiniCamera is part of" ] ]  // 
