...
*
* Description:
* This Hubitat driver provides a spot to put data from Blink sync modules
*
...
* 
* Features List:
* Ability to Arm/Disarm the system the SyncModule is on
...
*
* Version Control:
* 0.1.3 - Correction to remove Driver Status when preferences are saved
* 0.1.2 - Correction to ProcessEvent function and removal of old driver-specific attributes when Preferences are saved
...
// Driver Metadata
metadata{
	definition( name: "BlinkChild-SyncModule", namespace: "Snell", author: "David Snell", importUrl: "https://www.drdsnell.com/projects/hubitat/drivers/BlinkChild-SyncModule.groovy" ) {
        capability "Sensor"
        capability "Actuator"
        capability "Switch"
        
        // Commands
        command "on", [ [ name: "This will Arm system Sync Module is on" ] ] // This will Arm system with a Sync Module device
        command "off", [ [ name: "This will Disarm system Sync Module is on" ] ] // This will Disarm system with a Sync Module device
        command "SystemArm", [ [ name: "This will Arm system Sync Module is on" ] ]  // 
        command "SystemDisarm", [ [ name: "This will Disarm system Sync Module is on" ] ]  // 
